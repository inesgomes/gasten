...
def main():
    ...
    if type(config['train']['step-1']) != str:
        ...
        print("GAN dir: ", original_gan_cp_dir)
    ...
    c_path = config['train']['step-2']['classifier']
    weight = config['train']['step-2']['weight']

    ###
    # Train modified GAN
    ###
    mod_gan_seed = gen_seed()
    ...
    epoch = step_1_train_state['best_epoch'] # this may be wrong
